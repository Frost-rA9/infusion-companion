...
if __name__ == '__main__':
    ...
    test_trans = transforms.Compose([
        ...
        transforms.ToTensor(),
        transforms.Normalize(mean=( 0.5077325), std=( 0.21166028)),
    ])
    ...
    pretrained_path = "235.95949538052082_0.75_model.pth"
    ...
    optimizer = optim.SGD(net.parameters(), lr=0.0001, momentum=0.3)
